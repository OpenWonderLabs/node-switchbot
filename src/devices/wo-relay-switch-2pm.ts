 ...
 */
export class WoRelaySwitch2PM extends WoRelaySwitch1 implements RelaySwitchChannelCommands {
  /**
   * Set channel 1 state
   */
  async setChannel1(state: boolean): Promise<boolean> {
   ...
   * Set channel 2 state
   */
  async setChannel2(state: boolean): Promise<boolean> {
