 ...
 */
export class WoRelaySwitch1 extends SequenceDevice implements RelaySwitchCommands {
  /**
  ...
  private parseRelayPowerResponse(buffer: Buffer): {
    voltage?: number
  ...
  private async getRelayPowerMonitoring(): Promise<{
    voltage?: number
    electricCurrent?: number
    electricityOfDay?: number
  }> {
