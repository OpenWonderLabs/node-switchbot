 ...
 *
 * types/device.ts: SwitchBot v4.0.0 - Device-Specific Type Definitions
 */
...
export interface RelaySwitchCommands {
   ...
   */
  getCurrentTimeAndStartTime?: () => Promise<{ currentTime: Date, startTime: Date, [key: string]: any }>
}
...
export interface KeypadStatus extends DeviceStatus {
  // Keypad is typically used for lock control
...
export interface RemoteStatus extends DeviceStatus {
  // Remote doesn't have controllable status, mainly for battery info
}
