...
describe('rgbicww Strip Light', () => {
  it('maps RGBICWW Strip Light device type to WoRGBICWWStripLight', () => {
  ...
  it('maps SwitchBot RGBICWW Strip Light device type to WoRGBICWWStripLight', () => {
    const switchbot = new SwitchBot({ enableBLE: false, token: '', secret: '' })
  ...
  it('inherits segmented control methods from WoRGBICBulb', () => {
    const switchbot = new SwitchBot({ enableBLE: false, token: '', secret: '' })
