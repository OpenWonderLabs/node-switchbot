...
describe('keypad Vision Pro', () => {
  it('maps Keypad Vision Pro device type to WoKeypadVisionPro', () => {
  ...
  it('maps SwitchBot Keypad Vision Pro device type to WoKeypadVisionPro', () => {
    const switchbot = new SwitchBot({ enableBLE: false, token: '', secret: '' })
  ...
  it('inherits getStatus() from WoKeypad', () => {
    const switchbot = new SwitchBot({ enableBLE: false, token: '', secret: '' })
