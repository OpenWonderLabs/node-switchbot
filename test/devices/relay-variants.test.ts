...
describe('relay switch variants', () => {
  it('maps Relay Switch 2PM to WoRelaySwitch2PM', async () => {
  ...
  it('maps Garage Door Opener to WoGarageDoorOpener', async () => {
    const switchbot = new SwitchBot({ enableBLE: false, token: '', secret: '' })
  ...
  it('woRelaySwitch2PM has channel-specific methods', async () => {
    const switchbot = new SwitchBot({ enableBLE: false, token: '', secret: '' })
  ...
  it('woGarageDoorOpener inherits relay switch methods', async () => {
    const switchbot = new SwitchBot({ enableBLE: false, token: '', secret: '' })
