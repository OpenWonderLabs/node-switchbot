...
describe('smart thermostat radiator variants', () => {
  it('maps Smart Thermostat Radiator to WoSmartThermostatRadiator', async () => {
  ...
  it('maps Thermostat Radiator to WoSmartThermostatRadiator', async () => {
    const switchbot = new SwitchBot({ enableBLE: false, token: '', secret: '' })
  ...
  it('maps Radiator Thermostat to WoSmartThermostatRadiator', async () => {
    const switchbot = new SwitchBot({ enableBLE: false, token: '', secret: '' })
