...
describe('keypad Vision', () => {
  it('maps Keypad Vision device type to WoKeypadVision', async () => {
  ...
  it('maps SwitchBot Keypad Vision device type to WoKeypadVision', async () => {
    const switchbot = new SwitchBot({ enableBLE: false, token: '', secret: '' })
  ...
  it('inherits keypad methods from WoKeypad', async () => {
    const switchbot = new SwitchBot({ enableBLE: false, token: '', secret: '' })
