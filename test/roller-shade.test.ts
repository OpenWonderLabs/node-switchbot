...
describe('roller Shade', () => {
  it('maps Roller Shade device type to WoRollerShade', () => {
  ...
  it('maps SwitchBot Roller Shade device type to WoRollerShade', () => {
    const switchbot = new SwitchBot({ enableBLE: false, token: '', secret: '' })
  ...
  it('inherits curtain control methods from WoCurtain', () => {
    const switchbot = new SwitchBot({ enableBLE: false, token: '', secret: '' })
