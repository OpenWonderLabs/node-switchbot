...
describe('lock model variants', () => {
  it('maps Lock Lite to WoSmartLockLite', () => {
  ...
  it('maps Lock Vision to WoSmartLockVision', () => {
    const switchbot = new SwitchBot({ enableBLE: false, token: '', secret: '' })
  ...
  it('maps Lock Vision Pro to WoSmartLockVisionPro', () => {
    const switchbot = new SwitchBot({ enableBLE: false, token: '', secret: '' })
  ...
  it('maps Lock Pro WiFi to WoSmartLockProWiFi', () => {
    const switchbot = new SwitchBot({ enableBLE: false, token: '', secret: '' })
  ...
  it('inherits lock() method from WoSmartLock', () => {
    const switchbot = new SwitchBot({ enableBLE: false, token: '', secret: '' })
  ...
  it('inherits unlatch() method from WoSmartLockPro for pro variants', () => {
    const switchbot = new SwitchBot({ enableBLE: false, token: '', secret: '' })
