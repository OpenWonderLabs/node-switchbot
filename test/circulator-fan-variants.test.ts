...
describe('circulator fan variants', () => {
  it('maps Battery Circulator Fan to WoCirculatorFan', () => {
  ...
  it('maps Circulator Fan to WoCirculatorFan', () => {
    const switchbot = new SwitchBot({ enableBLE: false, token: '', secret: '' })
  ...
  it('maps USB Circulator Fan to WoCirculatorFan', () => {
    const switchbot = new SwitchBot({ enableBLE: false, token: '', secret: '' })
  ...
  it('inherits fan control methods', () => {
    const switchbot = new SwitchBot({ enableBLE: false, token: '', secret: '' })
